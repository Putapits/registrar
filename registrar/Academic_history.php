...
<!-- Sidebar Navigation -->
    <aside class="sidebar">
        ...
        <ul class="nav-list">
            ...
            <li class="nav-item">
                <a href="Academic_history.php" class="nav-link active">
    ...
    <main class="main-content">
        ...
        <div class="dashboard-body">
            <div class="page-title">
                <h1><i class="fa-solid fa-book-open" style="color: var(--primary-color); margin-right: 15px; font-size: 0.9em;"></i>Academic History</h1>
                <p>Previous schools attended, scholastic records. Here is the raw data available.</p>
            </div>
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                <thead>
                    <tr><th>Student ID</th><th>Previous School</th><th>Year Completed</th><th>GPA</th><th>Remarks</th></tr>
                </thead>
                <tbody>
                    <?php foreach($mock_academic as $row): ?>
                    <tr><td><?php echo $row["student_id"]; ?></td><td><?php echo $row["prev_school"]; ?></td><td><?php echo $row["year_completed"]; ?></td><td><?php echo $row["gpa"]; ?></td><td><?php echo $row["remarks"]; ?></td></tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        </div>
