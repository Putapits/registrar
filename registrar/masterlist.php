    ...
    <main class="main-content">
        ...
        <div class="dashboard-body">
            <div class="page-title">
                <h1><i class="fa-solid fa-list-ol" style="color: var(--primary-color); margin-right: 15px; font-size: 0.9em;"></i>Student Masterlist</h1>
                <p>Official class masterlists and registrar reports. Here is the raw data available.</p>
            </div>
        ...
        <div class="table-header-controls">
            ...
            <div style="display: flex; gap: 10px;">
                <button class="btn" onclick="exportTableToCSV('masterlist.csv')" style="background-color: var(--secondary-color);"><i class="fa-solid fa-file-export"></i> Export CSV</button>
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                <thead>
                    <tr><th>No.</th><th>Student ID</th><th>Name</th><th>Grade</th><th>Section</th><th>Gender</th></tr>
                </thead>
                <tbody>
                    <?php foreach($mock_masterlist as $row): ?>
                    <tr><td><?php echo $row["no"]; ?></td><td><?php echo $row["student_id"]; ?></td><td><?php echo $row["name"]; ?></td><td><?php echo $row["course_grade"]; ?></td><td><?php echo $row["section"]; ?></td><td><?php echo $row["gender"]; ?></td></tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        </div>
