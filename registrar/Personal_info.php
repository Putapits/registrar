...
<!-- Sidebar Navigation -->
    <aside class="sidebar">
        ...
        <ul class="nav-list">
            ...
            <li class="nav-item">
                <a href="Personal_info.php" class="nav-link active">
    ...
    <main class="main-content">
        ...
        <div class="dashboard-body">
            <div class="page-title">
                <h1><i class="fa-solid fa-users" style="color: var(--primary-color); margin-right: 15px; font-size: 0.9em;"></i>Personal Info Database</h1>
                <p>Core student details, profiles, and demographic information. Here is the raw data available.</p>
            </div>
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                <thead>
                    <tr><th>Student ID</th><th>Student Name</th><th>Gender</th><th>Date of Birth</th><th>Address</th><th>Grade / Program</th><th>Section</th><th>Status</th></tr>
                </thead>
                <tbody>
                    <?php foreach($mock_info as $row): ?>
                    <tr><td><?php echo $row["student_id"]; ?></td><td><?php echo $row["student_name"]; ?></td><td><?php echo $row["gender"]; ?></td><td><?php echo $row["dob"]; ?></td><td><?php echo $row["address"]; ?></td><td><?php echo $row["program"]; ?></td><td><?php echo $row["section"]; ?></td><td><span class="status-badge"><?php echo $row["status"]; ?></span></td></tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        </div>
