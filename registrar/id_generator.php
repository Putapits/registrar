...
<!-- Sidebar Navigation -->
    <aside class="sidebar">
        ...
        <ul class="nav-list">
            ...
            <li class="nav-item">
                <a href="id_generator.php" class="nav-link active">
    ...
    <main class="main-content">
        ...
        <div class="dashboard-body">
            <div class="page-title">
                <h1><i class="fa-solid fa-id-card" style="color: var(--primary-color); margin-right: 15px; font-size: 0.9em;"></i>ID Generation Requests</h1>
                <p>Track ID card printing requests. Here is the raw data available.</p>
            </div>
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                <thead>
                    <tr><th>Request ID</th><th>Student ID</th><th>Name</th><th>Request Date</th><th>Status</th></tr>
                </thead>
                <tbody>
                    <?php foreach($mock_id_queue as $row): ?>
                    <tr><td><?php echo $row["request_id"]; ?></td><td><?php echo $row["student_id"]; ?></td><td><?php echo $row["name"]; ?></td><td><?php echo $row["request_date"]; ?></td><td><span class="status-badge"><?php echo $row["status"]; ?></span></td></tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        </div>
