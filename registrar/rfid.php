    ...
    <main class="main-content">
        ...
        <div class="dashboard-body">
            <div class="page-title">
                <h1><i class="fa-solid fa-wifi" style="color: var(--primary-color); margin-right: 15px; font-size: 0.9em;"></i>RFID Log / ID Scanning</h1>
                <p>Daily RFID tap logs. Here is the raw data available.</p>
            </div>
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                <thead>
                    <tr><th>Log ID</th><th>RFID UID</th><th>Student ID</th><th>Name</th><th>Timestamp</th><th>Type</th></tr>
                </thead>
                <tbody>
                    <?php foreach($mock_rfid_logs as $row): ?>
                    <tr><td><?php echo $row["log_id"]; ?></td><td><?php echo $row["rfid_uid"]; ?></td><td><?php echo $row["student_id"]; ?></td><td><?php echo $row["name"]; ?></td><td><?php echo $row["timestamp"]; ?></td><td><?php echo $row["type"]; ?></td></tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        </div>
