...
<!-- Sidebar Navigation -->
    <aside class="sidebar">
        ...
        <ul class="nav-list">
            ...
            <li class="nav-item">
                <a href="Guardian&Emergency_Contact.php" class="nav-link active">
    ...
    <main class="main-content">
        ...
        <div class="dashboard-body">
            <div class="page-title">
                <h1><i class="fa-solid fa-hands-holding-child" style="color: var(--primary-color); margin-right: 15px; font-size: 0.9em;"></i>Guardian & Emergency Contact</h1>
                <p>Records of parents, guardians, and contact persons. Here is the raw data available.</p>
            </div>
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                <thead>
                    <tr><th>Guardian Name</th><th>Relationship</th><th>Contact Number</th><th>Email</th><th>Address</th></tr>
                </thead>
                <tbody>
                    <?php foreach($mock_contacts as $row): ?>
                    <tr><td><?php echo $row["guardian_name"]; ?></td><td><?php echo $row["relationship"]; ?></td><td><?php echo $row["contact_number"]; ?></td><td><?php echo $row["email"]; ?></td><td><?php echo $row["address"]; ?></td></tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        </div>
