...
<!-- Sidebar Navigation -->
    <aside class="sidebar">
        ...
        <ul class="nav-list">
            ...
            <li class="nav-item">
                <a href="Health_Record_log.php" class="nav-link active">
    ...
    <main class="main-content">
        ...
        <div class="dashboard-body">
            <div class="page-title">
                <h1><i class="fa-solid fa-truck-medical" style="color: var(--primary-color); margin-right: 15px; font-size: 0.9em;"></i>Health Record Log</h1>
                <p>Student medical conditions, clinic visits. Here is the raw data available.</p>
            </div>
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                <thead>
                    <tr><th>Student ID</th><th>Blood Type</th><th>Allergies</th><th>Medical Conditions</th><th>Emergency Medication</th></tr>
                </thead>
                <tbody>
                    <?php foreach($mock_health as $row): ?>
                    <tr><td><?php echo $row["student_id"]; ?></td><td><?php echo $row["blood_type"]; ?></td><td><?php echo $row["allergies"]; ?></td><td><?php echo $row["medical_conditions"]; ?></td><td><?php echo $row["emergency_med"]; ?></td></tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        </div>
