    ...
    <main class="main-content">
        ...
        <div class="dashboard-body">
            <div class="page-title">
                <h1><i class="fa-solid fa-folder-tree" style="color: var(--primary-color); margin-right: 15px; font-size: 0.9em;"></i>Digital File Storage</h1>
                <p>Digital copies of submitted student requirements. Here is the raw data available.</p>
            </div>
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                <thead>
                    <tr><th>File ID</th><th>Student ID</th><th>Filename</th><th>File Type</th><th>Upload Date</th><th>Size</th></tr>
                </thead>
                <tbody>
                    <?php foreach($mock_storage as $row): ?>
                    <tr><td><?php echo $row["file_id"]; ?></td><td><?php echo $row["student_id"]; ?></td><td><?php echo $row["filename"]; ?></td><td><?php echo $row["file_type"]; ?></td><td><?php echo $row["upload_date"]; ?></td><td><?php echo $row["size"]; ?></td></tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        </div>
