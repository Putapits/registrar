...
<!-- Sidebar Navigation -->
    <aside class="sidebar">
        ...
        <ul class="nav-list">
            ...
            <li class="nav-item">
                <a href="docu.php" class="nav-link active">
    ...
    <main class="main-content">
        ...
        <div class="dashboard-body">
            <div class="page-title">
                <h1><i class="fa-solid fa-file-invoice" style="color: var(--primary-color); margin-right: 15px; font-size: 0.9em;"></i>Document Requests</h1>
                <p>Requests for Form 137, Cert. of Good Moral Character, etc. Here is the raw data available.</p>
            </div>
        ...
        <div class="table-header-controls">
            ...
            <div style="display: flex; gap: 10px;">
                <button class="btn" onclick="exportTableToCSV('documents.csv')" style="background-color: var(--secondary-color);"><i class="fa-solid fa-file-export"></i> Export CSV</button>
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                <thead>
                    <tr><th>Request ID</th><th>Student ID</th><th>Document Type</th><th>Purpose</th><th>Request Date</th><th>Status</th></tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; align-items: center; justify-content: space-between; gap: 10px;">
                                <span class="doc-type-text"><?php echo $row["document_type"]; ?></span>
                                <label style="cursor: pointer; background: var(--primary-light); color: var(--primary-dark); padding: 4px 8px; border-radius: 6px; font-size: 0.70rem; font-weight: 700; transition: all 0.2s;">
                                    <i class="fa-solid fa-upload"></i> Import File
                                    <input type="file" accept=".pdf,.png,.jpg,.jpeg,.doc,.docx" style="display: none;" onchange="importFile(event, '<?php echo $row['request_id']; ?>')">
                                </label>
                            </div>
                        </td>
...
endforeach; ?>
    ...
    function exportTableToCSV(filename) {
        ...
        for (var i = 0; i < rows.length; i++) {
            ...
            for (var j = 0; j < cols.length; j++) {
                ...
                // Specifically extract only the document type text and ignore the import button text
                if (j === 2 && cols[j].querySelector('.doc-type-text')) {
                    text = cols[j].querySelector('.doc-type-text').innerText;
                }
    ...
    function importFile(event, requestId) {
        const file = event.target.files[0];
        if (!file) return;

        alert("File '" + file.name + "' for Request ID " + requestId + " successfully prepared for upload!");
        event.target.value = ''; // Reset the input so the same file could be selected again if needed
    }
    </script>
</html>